...
const SearchSection = ({onSearchInput}) => {
  return (
    <div className='p-10 bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800  flex flex-col items-center justify-center '>
